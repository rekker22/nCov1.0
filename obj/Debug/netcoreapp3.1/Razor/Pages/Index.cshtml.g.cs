#pragma checksum "E:\WPF_projects\nCov1.0\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c568f766aed4a038509457f028246b9704c843da"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c568f766aed4a038509457f028246b9704c843da", @"/Pages/Index.cshtml")]
...
#nullable disable
    ...
    <div id=""Data"" class=""dropdown"" style=""
        ...
        border-color: #BCBAB7;");
            ...
            BeginWriteAttribute("style", " style=\"", 2284, "\"", 2292, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                Total Cases
        </label>
...
<script>
    ...
    xhttp.open(""GE");
            WriteLiteral(@"T"", ""api/ncsdget"", true);
    xhttp.send();

    async function heatmaponoffchange() {
        if (heatmaponoff == false) {
            heatmaponoff = true;
            heat = L.heatLayer(myArr, { radius: 100 }
            ).addTo(mymap);
...
#nullable disable
        ...
        for (var i in data.features[0].context) {
            ...
            WriteLiteral(@" (myarr[d].dName == district) {
                                document.getElementById(""totalcases"").innerHTML = district + "" has total "" + myarr[d].totalCases + "" COVID cases are "";
                                break;
                            }
                        }
